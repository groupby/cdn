...
/***/ function(module, exports, __webpack_require__) {
	...
	riot.tag2('gb-available-navigation', '<div class="gb-side-nav {opts.style()}"> <div class="gb-nav" each="{nav in available}"> <h4 class="gb-nav__title">{nav.displayName}</h4> <ul class="gb-nav__list"> <gb-available-refinement each="{ref in nav.refinements}" ref="{ref}"></gb-available-refinement> </ul> </div> </div>', 'gb-available-navigation .gb-stylish h4,[riot-tag="gb-available-navigation"] .gb-stylish h4,[data-is="gb-available-navigation"] .gb-stylish h4{ font-size: 18px; margin: 10px 0; } gb-available-navigation .gb-stylish.gb-side-nav,[riot-tag="gb-available-navigation"] .gb-stylish.gb-side-nav,[data-is="gb-available-navigation"] .gb-stylish.gb-side-nav{ padding: 12px; } gb-available-navigation .gb-stylish .gb-nav__list,[riot-tag="gb-available-navigation"] .gb-stylish .gb-nav__list,[data-is="gb-available-navigation"] .gb-stylish .gb-nav__list{ margin: 0; padding-left: 8px; }', '', function (opts) {
	    var _this = this;
	    ...
	    opts.flux.on(opts.flux.RESULTS, function (res) {
	        return _this.update({ available: res.availableNavigation });
	    });
	});
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(42)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	riot.tag2('gb-selected-navigation', '<ul class="gb-list"> <li each="{nav in selected}" nav="{nav}"> <ul class="gb-list"> <gb-selected-refinement each="{ref in nav.refinements}" ref="{ref}"></gb-selected-refinement> </ul> </li> </ul>', '', '', function (opts) {
	    var _this = this;
...
/***/ function(module, exports, __webpack_require__) {
	...
	riot.tag2('gb-selected-refinement', '<li> <a href="#" onclick="{remove}">×</a> <b>{parent.nav.displayName}: {ref.type === \'Value\' ? ref.value : ref.low + \' .. \' + ref.high}</b> </li>', '', '', function (opts) {
	    var _this = this;

	    var utils = __webpack_require__(41);
	    this.parentOpts = this.parent.parent.opts;
	    this.remove = function () {
	        return _this.parentOpts.flux.unrefine(utils.toRefinement(opts.ref, _this.parent.nav));
	    };
	});
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(42)))
