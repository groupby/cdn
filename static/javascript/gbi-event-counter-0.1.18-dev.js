(function(global, factory) {
  typeof exports === "object" && typeof module !== "undefined" ? module.exports = factory() : typeof define === "function" && define.amd ? define(factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, global.GBIEventCounter = factory());
})(this, function() {
  "use strict";
  let _instance;
  let _listeners = [];
  ...
  const send = async (event, options) => {
    ...
    try {
      ...
      throw new Error((e == null ? void 0 : e.message) ?? "Error sending event");
    }
  };
  let _tracker;
  let _customerId;
