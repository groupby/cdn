...
/***/ function(module, exports, __webpack_require__) {
	...
	riot.tag2('gb-query', '<div class="gb-query {opts.style()}"> <input class="gb-query__box" type="text" placeholder="Search..."> <a class="gb-query__reset" onclick="{clearQuery}">×</a> </div>', 'gb-query .gb-stylish .gb-query__box,[riot-tag="gb-query"] .gb-stylish .gb-query__box,[data-is="gb-query"] .gb-stylish .gb-query__box{ padding: 6px 12px; font-size: 14px; } gb-query .gb-stylish .gb-query__reset,[riot-tag="gb-query"] .gb-stylish .gb-query__reset,[data-is="gb-query"] .gb-stylish .gb-query__reset{ color: #888; } gb-query .gb-stylish .gb-query__reset:hover,[riot-tag="gb-query"] .gb-stylish .gb-query__reset:hover,[data-is="gb-query"] .gb-stylish .gb-query__reset:hover{ color: black; cursor: pointer; }', '', function (opts) {
	  __webpack_require__(46);
...
/***/ function(module, exports, __webpack_require__) {
	...
	riot.tag2('gb-raw-results', '<ul class="gb-results {this.parent.opts.style()}"> <li class="gb-results__item" each="{records}"> <div class="gb-product"> <yield></yield> </div> </li> </ul>', 'gb-raw-results .gb-stylish.gb-results,[riot-tag="gb-raw-results"] .gb-stylish.gb-results,[data-is="gb-raw-results"] .gb-stylish.gb-results{ list-style: none; } gb-raw-results .gb-stylish .gb-product,[riot-tag="gb-raw-results"] .gb-stylish .gb-product,[data-is="gb-raw-results"] .gb-stylish .gb-product{ display: flex; flex-direction: column; align-items: center; justify-content: center; text-align: center; }', '', function (opts) {
	    var _this = this;
